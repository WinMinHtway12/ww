    ...
    <div class="row">
        <div class="col-md-3">
            <div class="flex-shrink-0 p-3 bg-white" style="width: 280px;">
                ...
                <button class="btn btn-secondary"> <a href="{{url('product/home')}}">Products
                    </a></button>
                ...
                <!-- <li><a href="{{url('product/home')}}" class="link-dark rounded">Show Product</a></li> -->
                ...
                <div class="col-sm-6 col-md-4 ">
                    <div class="thumbnail mb-4">
                        <div class="caption">
                            ...
                            <a href="#" class="btn btn-primary btn-sm" role="button">Detail</a>
